...
4. DETAILED DIAGRAMS (ASCII art, multiple if needed)
...
4. DIAGRAM (ASCII ≤ 5 lines, if helpful)
...
- Include ASCII diagrams, charts, and visual representations
- Use spatial organization and formatting
- Provide visual metaphors and imagery
- "Picture this..." explanations
"""
