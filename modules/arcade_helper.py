...
MAP_QUESTIONS = {
    "easy": [
        ...
        {"question": "What state is Detroit in?", "answer": "Michigan", "options": ["Michigan", "Ohio", "Illinois", "Wisconsin"]},
        {"question": "What river forms part of the Texas-Mexico border?", "answer": "Rio Grande", "options": ["Rio Grande", "Mississippi", "Colorado", "Missouri"]},
        {"question": "What are the five Great Lakes?", "answer": "Superior, Michigan, Huron, Erie, Ontario", "options": ["Superior, Michigan, Huron, Erie, Ontario", "Atlantic, Pacific, Indian, Arctic, Southern", "Mississippi, Missouri, Colorado, Rio Grande, Hudson", "Victoria, Albert, Tanganyika, Malawi, Chad"]},
        {"question": "What state is Mount Rushmore in?", "answer": "South Dakota", "options": ["South Dakota", "North Dakota", "Montana", "Wyoming"]},
        {"question": "What is the capital of Texas?", "answer": "Austin", "options": ["Austin", "Houston", "Dallas", "San Antonio"]},
        {"question": "What state borders the most other states?", "answer": "Tennessee", "options": ["Tennessee", "Kentucky", "Missouri", "Colorado"]},
        {"question": "What is the largest city in Alaska?", "answer": "Anchorage", "options": ["Anchorage", "Juneau", "Fairbanks", "Sitka"]},
        {"question": "What mountains run through Virginia?", "answer": "Appalachian", "options": ["Appalachian", "Rocky", "Cascades", "Sierra Nevada"]},
        {"question": "What state is Yellowstone mostly in?", "answer": "Wyoming", "options": ["Wyoming", "Montana", "Idaho", "Utah"]},
        {"question": "What lake is in Nevada and California?", "answer": "Lake Tahoe", "options": ["Lake Tahoe", "Great Salt Lake", "Crater Lake", "Lake Mead"]},
        {"question": "What state is Boston in?", "answer": "Massachusetts", "options": ["Massachusetts", "Connecticut", "Rhode Island", "Maine"]},
        {"question": "What ocean is north of Alaska?", "answer": "Arctic", "options": ["Arctic", "Pacific", "Atlantic", "Indian"]},
        {"question": "What state has no coastline and is rectangular?", "answer": "Colorado", "options": ["Colorado", "Wyoming", "Kansas", "New Mexico"]},
        {"question": "What is the warmest ocean?", "answer": "Indian", "options": ["Indian", "Pacific", "Atlantic", "Arctic"]},
        {"question": "What state has the most earthquakes?", "answer": "Alaska", "options": ["Alaska", "California", "Hawaii", "Washington"]},
        {"question": "What river flows through the Grand Canyon?", "answer": "Colorado", "options": ["Colorado", "Rio Grande", "Snake", "Columbia"]},
        {"question": "What is the deepest lake in the US?", "answer": "Crater Lake", "options": ["Crater Lake", "Lake Tahoe", "Lake Superior", "Great Salt Lake"]},
        {"question": "What state is shaped like a mitten?", "answer": "Michigan", "options": ["Michigan", "Wisconsin", "Minnesota", "Florida"]},
        {"question": "What city is on seven hills?", "answer": "San Francisco", "options": ["San Francisco", "Seattle", "Los Angeles", "San Diego"]},
        {"question": "What is the northernmost state?", "answer": "Alaska", "options": ["Alaska", "Maine", "Washington", "Minnesota"]},
        {"question": "What state has the most volcanoes?", "answer": "Alaska", "options": ["Alaska", "Hawaii", "Washington", "California"]},
        {"question": "What is America's bread basket region?", "answer": "Great Plains", "options": ["Great Plains", "Mississippi Delta", "California Valley", "Atlantic Coast"]},
        {"question": "What state is Niagara Falls partly in?", "answer": "New York", "options": ["New York", "Pennsylvania", "Ohio", "Michigan"]},
        {"question": "What is the tallest mountain in North America?", "answer": "Denali", "options": ["Denali", "Mount Rainier", "Mount Whitney", "Pikes Peak"]},
        {"question": "What peninsula is Florida on?", "answer": "Florida Peninsula", "options": ["Florida Peninsula", "Baja Peninsula", "Yucatan Peninsula", "Iberian Peninsula"]},
        {"question": "What state capital is highest in elevation?", "answer": "Santa Fe", "options": ["Santa Fe", "Denver", "Cheyenne", "Salt Lake City"]},
        {"question": "What is the largest freshwater lake entirely in the US?", "answer": "Lake Michigan", "options": ["Lake Michigan", "Lake Superior", "Lake Huron", "Lake Erie"]},
        {"question": "What state has the Everglades?", "answer": "Florida", "options": ["Florida", "Louisiana", "Georgia", "South Carolina"]},
        {"question": "What city is called the Windy City?", "answer": "Chicago", "options": ["Chicago", "Boston", "Seattle", "San Francisco"]},
        {"question": "What state has the most national parks?", "answer": "California", "options": ["California", "Alaska", "Utah", "Colorado"]},
        {"question": "What is the largest bay in the US?", "answer": "Chesapeake Bay", "options": ["Chesapeake Bay", "San Francisco Bay", "Tampa Bay", "Hudson Bay"]},
        {"question": "What state is Mount St. Helens in?", "answer": "Washington", "options": ["Washington", "Oregon", "California", "Alaska"]},
        {"question": "What desert is in southern California?", "answer": "Mojave", "options": ["Mojave", "Sonoran", "Chihuahuan", "Great Basin"]},
        {"question": "What is the southernmost point of the continental US?", "answer": "Key West, Florida", "options": ["Key West, Florida", "San Diego, California", "Brownsville, Texas", "New Orleans, Louisiana"]},
        {"question": "What state is Mount Rainier in?", "answer": "Washington", "options": ["Washington", "Oregon", "Alaska", "Montana"]},
        {"question": "What major fault line is in California?", "answer": "San Andreas", "options": ["San Andreas", "Cascadia", "New Madrid", "Wasatch"]},
        {"question": "What state is Crater Lake in?", "answer": "Oregon", "options": ["Oregon", "Washington", "California", "Idaho"]},
        {"question": "What mountains separate California and Nevada?", "answer": "Sierra Nevada", "options": ["Sierra Nevada", "Cascade Range", "Coast Range", "Rocky Mountains"]},
        {"question": "What is the coldest state on average?", "answer": "Alaska", "options": ["Alaska", "North Dakota", "Minnesota", "Wyoming"]},
    ],
    "medium": [
        ...
        {"question": "What is the capital of Russia?", "answer": "Moscow", "options": ["Moscow", "St. Petersburg", "Kazan", "Novosibirsk"]},
        {"question": "What country is home to the Amazon rainforest?", "answer": "Brazil", "options": ["Brazil", "Colombia", "Venezuela", "Ecuador"]},
        {"question": "What is the capital of Egypt?", "answer": "Cairo", "options": ["Cairo", "Alexandria", "Luxor", "Giza"]},
        {"question": "What sea is the saltiest in the world?", "answer": "Dead Sea", "options": ["Dead Sea", "Red Sea", "Black Sea", "Caspian Sea"]},
        {"question": "What is the capital of South Korea?", "answer": "Seoul", "options": ["Seoul", "Busan", "Incheon", "Pyongyang"]},
        {"question": "What mountain range runs through South America?", "answer": "Andes", "options": ["Andes", "Rockies", "Himalayas", "Atlas"]},
        {"question": "What is the capital of Mexico?", "answer": "Mexico City", "options": ["Mexico City", "Guadalajara", "Monterrey", "Cancun"]},
        {"question": "What country is the Parthenon in?", "answer": "Greece", "options": ["Greece", "Italy", "Turkey", "Egypt"]},
        {"question": "What is the capital of Turkey?", "answer": "Ankara", "options": ["Ankara", "Istanbul", "Izmir", "Bursa"]},
        {"question": "What ocean is Hawaii in?", "answer": "Pacific", "options": ["Pacific", "Atlantic", "Indian", "Arctic"]},
        {"question": "What is the capital of Argentina?", "answer": "Buenos Aires", "options": ["Buenos Aires", "Cordoba", "Rosario", "Mendoza"]},
        {"question": "What river runs through Egypt?", "answer": "Nile", "options": ["Nile", "Niger", "Congo", "Zambezi"]},
        {"question": "What is the capital of Poland?", "answer": "Warsaw", "options": ["Warsaw", "Krakow", "Gdansk", "Poznan"]},
        {"question": "What country has Angkor Wat?", "answer": "Cambodia", "options": ["Cambodia", "Thailand", "Vietnam", "Laos"]},
        {"question": "What is the capital of Sweden?", "answer": "Stockholm", "options": ["Stockholm", "Gothenburg", "Malmo", "Uppsala"]},
        {"question": "What desert covers much of northern Africa?", "answer": "Sahara", "options": ["Sahara", "Kalahari", "Namib", "Arabian"]},
        {"question": "What is the capital of Norway?", "answer": "Oslo", "options": ["Oslo", "Bergen", "Trondheim", "Stavanger"]},
        {"question": "What country is Mount Fuji in?", "answer": "Japan", "options": ["Japan", "China", "Korea", "Taiwan"]},
        {"question": "What is the capital of Thailand?", "answer": "Bangkok", "options": ["Bangkok", "Chiang Mai", "Phuket", "Pattaya"]},
        {"question": "What mountain range separates France and Spain?", "answer": "Pyrenees", "options": ["Pyrenees", "Alps", "Carpathians", "Apennines"]},
        {"question": "What is the capital of South Africa?", "answer": "Pretoria", "options": ["Pretoria", "Cape Town", "Johannesburg", "Durban"]},
        {"question": "What river runs through London?", "answer": "Thames", "options": ["Thames", "Seine", "Rhine", "Danube"]},
        {"question": "What is the capital of Indonesia?", "answer": "Jakarta", "options": ["Jakarta", "Bali", "Surabaya", "Bandung"]},
        {"question": "What country is the Great Barrier Reef near?", "answer": "Australia", "options": ["Australia", "Philippines", "Indonesia", "Papua New Guinea"]},
        {"question": "What is the capital of Netherlands?", "answer": "Amsterdam", "options": ["Amsterdam", "Rotterdam", "The Hague", "Utrecht"]},
        {"question": "What island country is south of India?", "answer": "Sri Lanka", "options": ["Sri Lanka", "Maldives", "Madagascar", "Mauritius"]},
        {"question": "What is the capital of Chile?", "answer": "Santiago", "options": ["Santiago", "Valparaiso", "Concepcion", "Vina del Mar"]},
        {"question": "What river runs through Paris?", "answer": "Seine", "options": ["Seine", "Loire", "Rhone", "Thames"]},
        {"question": "What is the capital of Vietnam?", "answer": "Hanoi", "options": ["Hanoi", "Ho Chi Minh City", "Da Nang", "Hue"]},
        {"question": "What country has the Colosseum?", "answer": "Italy", "options": ["Italy", "Greece", "Spain", "Turkey"]},
        {"question": "What is the capital of Greece?", "answer": "Athens", "options": ["Athens", "Sparta", "Thessaloniki", "Crete"]},
        {"question": "What canal connects the Mediterranean to the Red Sea?", "answer": "Suez Canal", "options": ["Suez Canal", "Panama Canal", "Erie Canal", "Corinth Canal"]},
        {"question": "What is the capital of New Zealand?", "answer": "Wellington", "options": ["Wellington", "Auckland", "Christchurch", "Queenstown"]},
        {"question": "What country is home to the ancient city of Petra?", "answer": "Jordan", "options": ["Jordan", "Israel", "Egypt", "Syria"]},
        {"question": "What is the capital of Austria?", "answer": "Vienna", "options": ["Vienna", "Salzburg", "Innsbruck", "Graz"]},
        {"question": "What strait separates Spain and Morocco?", "answer": "Strait of Gibraltar", "options": ["Strait of Gibraltar", "Bering Strait", "Strait of Hormuz", "Strait of Malacca"]},
        {"question": "What is the capital of Portugal?", "answer": "Lisbon", "options": ["Lisbon", "Porto", "Faro", "Braga"]},
        {"question": "What country has the most active volcanoes?", "answer": "Indonesia", "options": ["Indonesia", "Japan", "Philippines", "Iceland"]},
        {"question": "What is the capital of Philippines?", "answer": "Manila", "options": ["Manila", "Cebu", "Davao", "Quezon City"]},
    ],
    "hard": [
        ...
        {"question": "What tectonic plate boundary type creates the Himalayas?", "answer": "convergent", "options": ["convergent", "divergent", "transform", "subduction"]},
        {"question": "What is the only sea without any coastline?", "answer": "Sargasso Sea", "options": ["Sargasso Sea", "Dead Sea", "Caspian Sea", "Aral Sea"]},
        {"question": "What African country has the most UNESCO World Heritage Sites?", "answer": "South Africa", "options": ["South Africa", "Egypt", "Morocco", "Ethiopia"]},
        {"question": "What is the world's second-longest river?", "answer": "Amazon", "options": ["Amazon", "Nile", "Yangtze", "Mississippi"]},
        {"question": "What country has borders with 14 other nations?", "answer": "China", "options": ["China", "Russia", "Brazil", "India"]},
        {"question": "What latitude line is the Tropic of Capricorn?", "answer": "23.5°S", "options": ["23.5°S", "23.5°N", "66.5°S", "0°"]},
        {"question": "What is the largest delta in the world?", "answer": "Ganges-Brahmaputra", "options": ["Ganges-Brahmaputra", "Nile", "Mississippi", "Amazon"]},
        {"question": "What climate zone is characterized by permafrost?", "answer": "tundra", "options": ["tundra", "taiga", "steppe", "desert"]},
        {"question": "What peninsula is home to North and South Korea?", "answer": "Korean Peninsula", "options": ["Korean Peninsula", "Indochina Peninsula", "Malay Peninsula", "Arabian Peninsula"]},
        {"question": "What ocean current brings cold water along South America's west coast?", "answer": "Humboldt Current", "options": ["Humboldt Current", "Gulf Stream", "Kuroshio Current", "California Current"]},
        {"question": "What is the largest country entirely in Europe?", "answer": "Ukraine", "options": ["Ukraine", "France", "Spain", "Sweden"]},
        {"question": "What geological feature forms where two tectonic plates move apart?", "answer": "rift valley", "options": ["rift valley", "mountain range", "trench", "plateau"]},
        {"question": "What is the most densely populated country in the world?", "answer": "Monaco", "options": ["Monaco", "Singapore", "Hong Kong", "Vatican City"]},
        {"question": "What body of water connects the Black Sea and Mediterranean?", "answer": "Bosphorus", "options": ["Bosphorus", "Dardanelles", "Suez Canal", "Strait of Gibraltar"]},
        {"question": "What type of climate is characterized by wet and dry seasons?", "answer": "tropical savanna", "options": ["tropical savanna", "monsoon", "Mediterranean", "humid subtropical"]},
        {"question": "What is the world's largest hot desert?", "answer": "Sahara", "options": ["Sahara", "Arabian", "Gobi", "Kalahari"]},
        {"question": "What country is the Caucasus Mountains primarily in?", "answer": "Georgia", "options": ["Georgia", "Russia", "Armenia", "Azerbaijan"]},
        {"question": "What is the term for land reclaimed from the sea?", "answer": "polder", "options": ["polder", "delta", "atoll", "fjord"]},
        {"question": "What river forms part of the border between USA and Mexico?", "answer": "Rio Grande", "options": ["Rio Grande", "Colorado", "Mississippi", "Columbia"]},
        {"question": "What is the world's highest capital city?", "answer": "La Paz", "options": ["La Paz", "Quito", "Bogota", "Kathmandu"]},
        {"question": "What sea lies between Italy and the Balkans?", "answer": "Adriatic Sea", "options": ["Adriatic Sea", "Aegean Sea", "Ionian Sea", "Tyrrhenian Sea"]},
        {"question": "What is the primary cause of the Coriolis effect?", "answer": "Earth's rotation", "options": ["Earth's rotation", "ocean currents", "wind patterns", "temperature"]},
        {"question": "What country has the southernmost capital city?", "answer": "New Zealand", "options": ["New Zealand", "Argentina", "Chile", "Australia"]},
        {"question": "What peninsula contains Spain and Portugal?", "answer": "Iberian Peninsula", "options": ["Iberian Peninsula", "Balkan Peninsula", "Italian Peninsula", "Scandinavian Peninsula"]},
        {"question": "What is the largest freshwater lake by surface area?", "answer": "Lake Superior", "options": ["Lake Superior", "Lake Victoria", "Lake Baikal", "Lake Michigan"]},
        {"question": "What type of rock forms from cooled magma?", "answer": "igneous", "options": ["igneous", "sedimentary", "metamorphic", "limestone"]},
        {"question": "What is the largest archipelago in the world?", "answer": "Indonesia", "options": ["Indonesia", "Philippines", "Japan", "Maldives"]},
        {"question": "What strait separates Europe from Asia in Turkey?", "answer": "Bosphorus", "options": ["Bosphorus", "Dardanelles", "Strait of Hormuz", "Strait of Malacca"]},
        {"question": "What is the term for a narrow strip of land connecting two larger areas?", "answer": "isthmus", "options": ["isthmus", "peninsula", "strait", "archipelago"]},
        {"question": "What country contains the geographic center of Europe?", "answer": "Lithuania", "options": ["Lithuania", "Poland", "Belarus", "Ukraine"]},
        {"question": "What ocean trench is deepest in the Atlantic?", "answer": "Puerto Rico Trench", "options": ["Puerto Rico Trench", "South Sandwich Trench", "Java Trench", "Mariana Trench"]},
        {"question": "What is the world's largest coral reef system?", "answer": "Great Barrier Reef", "options": ["Great Barrier Reef", "New Caledonia Barrier Reef", "Mesoamerican Reef", "Red Sea Coral Reef"]},
        {"question": "What climate classification system uses letters like Af, BWh, and Dfc?", "answer": "Köppen", "options": ["Köppen", "Thornthwaite", "Trewartha", "Holdridge"]},
        {"question": "What is the largest cold desert in the world?", "answer": "Antarctic Desert", "options": ["Antarctic Desert", "Arctic Desert", "Gobi", "Great Basin"]},
        {"question": "What fault line runs through California?", "answer": "San Andreas Fault", "options": ["San Andreas Fault", "Hayward Fault", "Ring of Fire", "Mid-Atlantic Ridge"]},
        {"question": "What is the world's largest estuary?", "answer": "Gulf of St. Lawrence", "options": ["Gulf of St. Lawrence", "Chesapeake Bay", "Rio de la Plata", "Amazon Estuary"]},
        {"question": "What percentage of Earth's surface is covered by water?", "answer": "71%", "options": ["71%", "60%", "80%", "50%"]},
        {"question": "What country has the longest coastline in the world?", "answer": "Canada", "options": ["Canada", "Russia", "Indonesia", "Norway"]},
        {"question": "What is the world's most volcanically active region?", "answer": "Ring of Fire", "options": ["Ring of Fire", "East African Rift", "Iceland", "Mediterranean"]},
        {"question": "What river delta is sinking the fastest?", "answer": "Mekong Delta", "options": ["Mekong Delta", "Nile Delta", "Mississippi Delta", "Ganges Delta"]},
    ]
}
...
def generate_element_match(difficulty='medium'):
    ...
    elements_easy = [
        ...
        {"symbol": "F", "name": "Fluorine", "options": ["Fluorine", "Iron", "Francium", "Fermium"]},
        {"symbol": "Si", "name": "Silicon", "options": ["Silicon", "Silver", "Sulfur", "Sodium"]},
        {"symbol": "Ar", "name": "Argon", "options": ["Argon", "Arsenic", "Silver", "Aluminum"]},
        {"symbol": "Ni", "name": "Nickel", "options": ["Nickel", "Nitrogen", "Neon", "Nobelium"]},
        {"symbol": "B", "name": "Boron", "options": ["Boron", "Bromine", "Barium", "Bismuth"]},
        {"symbol": "Pb", "name": "Lead", "options": ["Lead", "Platinum", "Phosphorus", "Palladium"]},
        {"symbol": "Hg", "name": "Mercury", "options": ["Mercury", "Magnesium", "Manganese", "Molybdenum"]},
        {"symbol": "Kr", "name": "Krypton", "options": ["Krypton", "Potassium", "Chromium", "Cadmium"]},
        {"symbol": "I", "name": "Iodine", "options": ["Iodine", "Iron", "Indium", "Iridium"]},
        {"symbol": "Br", "name": "Bromine", "options": ["Bromine", "Boron", "Barium", "Beryllium"]},
        {"symbol": "Xe", "name": "Xenon", "options": ["Xenon", "Zinc", "Yttrium", "Zirconium"]},
        {"symbol": "Ti", "name": "Titanium", "options": ["Titanium", "Tin", "Thallium", "Tantalum"]},
        {"symbol": "Mn", "name": "Manganese", "options": ["Manganese", "Magnesium", "Mercury", "Molybdenum"]},
        {"symbol": "Co", "name": "Cobalt", "options": ["Cobalt", "Copper", "Carbon", "Chromium"]},
        {"symbol": "Cr", "name": "Chromium", "options": ["Chromium", "Carbon", "Copper", "Curium"]},
        {"symbol": "V", "name": "Vanadium", "options": ["Vanadium", "Yttrium", "Vanadium", "Bismuth"]},
        {"symbol": "Sn", "name": "Tin", "options": ["Tin", "Titanium", "Tantalum", "Thallium"]},
        {"symbol": "W", "name": "Tungsten", "options": ["Tungsten", "Titanium", "Tantalum", "Tin"]},
        {"symbol": "Pt", "name": "Platinum", "options": ["Platinum", "Potassium", "Phosphorus", "Lead"]},
        {"symbol": "U", "name": "Uranium", "options": ["Uranium", "Yttrium", "Vanadium", "Zinc"]},
        {"symbol": "Ba", "name": "Barium", "options": ["Barium", "Boron", "Bromine", "Beryllium"]},
        {"symbol": "Sr", "name": "Strontium", "options": ["Strontium", "Sulfur", "Silicon", "Scandium"]},
        {"symbol": "Rb", "name": "Rubidium", "options": ["Rubidium", "Radon", "Radium", "Rhenium"]},
        {"symbol": "Be", "name": "Beryllium", "options": ["Beryllium", "Boron", "Barium", "Bromine"]},
        {"symbol": "As", "name": "Arsenic", "options": ["Arsenic", "Argon", "Silver", "Aluminum"]},
        {"symbol": "Se", "name": "Selenium", "options": ["Selenium", "Sulfur", "Silicon", "Scandium"]},
        {"symbol": "Cd", "name": "Cadmium", "options": ["Cadmium", "Calcium", "Carbon", "Californium"]},
        {"symbol": "Sb", "name": "Antimony", "options": ["Antimony", "Silver", "Arsenic", "Selenium"]},
        {"symbol": "Te", "name": "Tellurium", "options": ["Tellurium", "Technetium", "Tantalum", "Terbium"]},
        {"symbol": "Cs", "name": "Cesium", "options": ["Cesium", "Copper", "Carbon", "Curium"]},
        {"symbol": "Bi", "name": "Bismuth", "options": ["Bismuth", "Boron", "Barium", "Beryllium"]},
        {"symbol": "Ra", "name": "Radium", "options": ["Radium", "Radon", "Rubidium", "Rhenium"]},
        {"symbol": "Rn", "name": "Radon", "options": ["Radon", "Radium", "Rubidium", "Rhenium"]},
        {"symbol": "Sc", "name": "Scandium", "options": ["Scandium", "Sulfur", "Silicon", "Strontium"]},
        {"symbol": "Y", "name": "Yttrium", "options": ["Yttrium", "Ytterbium", "Xenon", "Zinc"]},
        {"symbol": "Zr", "name": "Zirconium", "options": ["Zirconium", "Zinc", "Xenon", "Yttrium"]},
        {"symbol": "Nb", "name": "Niobium", "options": ["Niobium", "Nitrogen", "Neon", "Nobelium"]},
        {"symbol": "Mo", "name": "Molybdenum", "options": ["Molybdenum", "Magnesium", "Manganese", "Mercury"]},
        {"symbol": "Tc", "name": "Technetium", "options": ["Technetium", "Tellurium", "Tantalum", "Titanium"]},
        {"symbol": "Ru", "name": "Ruthenium", "options": ["Ruthenium", "Rubidium", "Radon", "Rhenium"]},
    ]

    elements_medium = [
        {"symbol": "Rh", "name": "Rhodium", "options": ["Rhodium", "Rubidium", "Radon", "Rhenium"]},
        {"symbol": "Pd", "name": "Palladium", "options": ["Palladium", "Platinum", "Phosphorus", "Lead"]},
        {"symbol": "In", "name": "Indium", "options": ["Indium", "Iodine", "Iron", "Iridium"]},
        {"symbol": "Ta", "name": "Tantalum", "options": ["Tantalum", "Tin", "Titanium", "Thallium"]},
        {"symbol": "Re", "name": "Rhenium", "options": ["Rhenium", "Radon", "Radium", "Rubidium"]},
        {"symbol": "Os", "name": "Osmium", "options": ["Osmium", "Oxygen", "Oganesson", "Oxide"]},
        {"symbol": "Ir", "name": "Iridium", "options": ["Iridium", "Iodine", "Iron", "Indium"]},
        {"symbol": "Tl", "name": "Thallium", "options": ["Thallium", "Tin", "Tantalum", "Titanium"]},
        {"symbol": "Po", "name": "Polonium", "options": ["Polonium", "Potassium", "Phosphorus", "Platinum"]},
        {"symbol": "At", "name": "Astatine", "options": ["Astatine", "Arsenic", "Argon", "Antimony"]},
        {"symbol": "Fr", "name": "Francium", "options": ["Francium", "Fluorine", "Iron", "Fermium"]},
        {"symbol": "Ac", "name": "Actinium", "options": ["Actinium", "Aluminum", "Argon", "Silver"]},
        {"symbol": "Th", "name": "Thorium", "options": ["Thorium", "Thallium", "Tantalum", "Tin"]},
        {"symbol": "Pa", "name": "Protactinium", "options": ["Protactinium", "Palladium", "Phosphorus", "Platinum"]},
        {"symbol": "Np", "name": "Neptunium", "options": ["Neptunium", "Nitrogen", "Neon", "Nickel"]},
        {"symbol": "Pu", "name": "Plutonium", "options": ["Plutonium", "Potassium", "Platinum", "Lead"]},
        {"symbol": "Am", "name": "Americium", "options": ["Americium", "Aluminum", "Silver", "Arsenic"]},
        {"symbol": "Cm", "name": "Curium", "options": ["Curium", "Copper", "Chromium", "Carbon"]},
        {"symbol": "Bk", "name": "Berkelium", "options": ["Berkelium", "Boron", "Barium", "Bromine"]},
        {"symbol": "Cf", "name": "Californium", "options": ["Californium", "Calcium", "Carbon", "Cadmium"]},
        {"symbol": "Es", "name": "Einsteinium", "options": ["Einsteinium", "Erbium", "Europium", "Selenium"]},
        {"symbol": "Fm", "name": "Fermium", "options": ["Fermium", "Fluorine", "Iron", "Francium"]},
        {"symbol": "Md", "name": "Mendelevium", "options": ["Mendelevium", "Molybdenum", "Manganese", "Mercury"]},
        {"symbol": "No", "name": "Nobelium", "options": ["Nobelium", "Nitrogen", "Neon", "Nickel"]},
        {"symbol": "Lr", "name": "Lawrencium", "options": ["Lawrencium", "Lithium", "Lead", "Lanthanum"]},
        {"symbol": "Rf", "name": "Rutherfordium", "options": ["Rutherfordium", "Rubidium", "Rhenium", "Radium"]},
        {"symbol": "Db", "name": "Dubnium", "options": ["Dubnium", "Dysprosium", "Darmstadtium", "Deuterium"]},
        {"symbol": "Sg", "name": "Seaborgium", "options": ["Seaborgium", "Sulfur", "Silicon", "Selenium"]},
        {"symbol": "Bh", "name": "Bohrium", "options": ["Bohrium", "Boron", "Barium", "Bismuth"]},
        {"symbol": "Hs", "name": "Hassium", "options": ["Hassium", "Hydrogen", "Helium", "Hafnium"]},
        {"symbol": "Mt", "name": "Meitnerium", "options": ["Meitnerium", "Manganese", "Magnesium", "Mercury"]},
        {"symbol": "Ds", "name": "Darmstadtium", "options": ["Darmstadtium", "Dubnium", "Dysprosium", "Deuterium"]},
        {"symbol": "Rg", "name": "Roentgenium", "options": ["Roentgenium", "Radon", "Radium", "Rhenium"]},
        {"symbol": "Cn", "name": "Copernicium", "options": ["Copernicium", "Carbon", "Copper", "Calcium"]},
        {"symbol": "Nh", "name": "Nihonium", "options": ["Nihonium", "Nitrogen", "Nickel", "Neon"]},
        {"symbol": "Fl", "name": "Flerovium", "options": ["Flerovium", "Fluorine", "Francium", "Iron"]},
        {"symbol": "Mc", "name": "Moscovium", "options": ["Moscovium", "Magnesium", "Manganese", "Molybdenum"]},
        {"symbol": "Lv", "name": "Livermorium", "options": ["Livermorium", "Lithium", "Lead", "Lawrencium"]},
        {"symbol": "Ts", "name": "Tennessine", "options": ["Tennessine", "Tellurium", "Tantalum", "Technetium"]},
        {"symbol": "Og", "name": "Oganesson", "options": ["Oganesson", "Oxygen", "Osmium", "Gold"]},
        {"symbol": "La", "name": "Lanthanum", "options": ["Lanthanum", "Lithium", "Lead", "Lutetium"]},
        {"symbol": "Ce", "name": "Cerium", "options": ["Cerium", "Cesium", "Calcium", "Carbon"]},
        {"symbol": "Pr", "name": "Praseodymium", "options": ["Praseodymium", "Promethium", "Protactinium", "Platinum"]},
        {"symbol": "Nd", "name": "Neodymium", "options": ["Neodymium", "Nitrogen", "Nobelium", "Sodium"]},
        {"symbol": "Pm", "name": "Promethium", "options": ["Promethium", "Praseodymium", "Platinum", "Phosphorus"]},
        {"symbol": "Sm", "name": "Samarium", "options": ["Samarium", "Scandium", "Selenium", "Sulfur"]},
        {"symbol": "Eu", "name": "Europium", "options": ["Europium", "Einsteinium", "Erbium", "Uranium"]},
        {"symbol": "Gd", "name": "Gadolinium", "options": ["Gadolinium", "Gold", "Gallium", "Germanium"]},
        {"symbol": "Tb", "name": "Terbium", "options": ["Terbium", "Tin", "Tantalum", "Tellurium"]},
        {"symbol": "Dy", "name": "Dysprosium", "options": ["Dysprosium", "Dubnium", "Darmstadtium", "Deuterium"]},
        {"symbol": "Ho", "name": "Holmium", "options": ["Holmium", "Hydrogen", "Helium", "Hafnium"]},
        {"symbol": "Er", "name": "Erbium", "options": ["Erbium", "Europium", "Einsteinium", "Uranium"]},
        {"symbol": "Tm", "name": "Thulium", "options": ["Thulium", "Thallium", "Tantalum", "Tin"]},
        {"symbol": "Yb", "name": "Ytterbium", "options": ["Ytterbium", "Yttrium", "Ytterbium", "Zinc"]},
        {"symbol": "Lu", "name": "Lutetium", "options": ["Lutetium", "Lithium", "Lead", "Lanthanum"]},
        {"symbol": "Hf", "name": "Hafnium", "options": ["Hafnium", "Hydrogen", "Helium", "Holmium"]},
        {"symbol": "Ga", "name": "Gallium", "options": ["Gallium", "Gold", "Germanium", "Gadolinium"]},
        {"symbol": "Ge", "name": "Germanium", "options": ["Germanium", "Gallium", "Gold", "Gadolinium"]},
        {"symbol": "Ag", "name": "Silver", "options": ["Silver", "Gold", "Argon", "Arsenic"]},
        {"symbol": "Au", "name": "Gold", "options": ["Gold", "Silver", "Aluminum", "Argon"]},
    ]
    ...
    elements_hard = [
        ...
        {"symbol": "Co", "name": "Cobalt", "options": ["Cobalt", "Copper", "Carbon", "Chromium"]},
        {"symbol": "Cr", "name": "Chromium", "options": ["Chromium", "Carbon", "Copper", "Curium"]},
        {"symbol": "V", "name": "Vanadium", "options": ["Vanadium", "Yttrium", "Uranium", "Bismuth"]},
        {"symbol": "Sn", "name": "Tin", "options": ["Tin", "Titanium", "Tantalum", "Thallium"]},
        {"symbol": "W", "name": "Tungsten", "options": ["Tungsten", "Titanium", "Tantalum", "Tin"]},
        {"symbol": "Pt", "name": "Platinum", "options": ["Platinum", "Potassium", "Phosphorus", "Lead"]},
        {"symbol": "U", "name": "Uranium", "options": ["Uranium", "Yttrium", "Vanadium", "Zinc"]},
...
def generate_history_timeline(difficulty='medium'):
    ...
    events = [
        ...
        {"event": "Protestant Reformation Begins", "year": 1517},
        {"event": "French Revolution Begins", "year": 1789},
        {"event": "Napoleon Defeated at Waterloo", "year": 1815},
        {"event": "American Civil War Ends", "year": 1865},
        {"event": "Transcontinental Railroad Completed", "year": 1869},
        {"event": "Wright Brothers First Flight", "year": 1903},
        {"event": "Titanic Sinks", "year": 1912},
        {"event": "Russian Revolution", "year": 1917},
        {"event": "Stock Market Crash", "year": 1929},
        {"event": "Pearl Harbor Attack", "year": 1941},
        {"event": "D-Day Normandy Invasion", "year": 1944},
        {"event": "United Nations Founded", "year": 1945},
        {"event": "Cold War Begins", "year": 1947},
        {"event": "Korean War Begins", "year": 1950},
        {"event": "Brown v. Board of Education", "year": 1954},
        {"event": "Cuban Missile Crisis", "year": 1962},
        {"event": "Martin Luther King Jr. Assassination", "year": 1968},
        {"event": "Vietnam War Ends", "year": 1975},
        {"event": "Personal Computer Introduced", "year": 1981},
        {"event": "Challenger Space Shuttle Disaster", "year": 1986},
        {"event": "Soviet Union Collapses", "year": 1991},
        {"event": "World Wide Web Created", "year": 1991},
        {"event": "Nelson Mandela Elected President", "year": 1994},
        {"event": "September 11 Attacks", "year": 2001},
        {"event": "First iPhone Released", "year": 2007},
        {"event": "Black Death Begins in Europe", "year": 1347},
        {"event": "Hundred Years War Begins", "year": 1337},
        {"event": "Joan of Arc Executed", "year": 1431},
        {"event": "Spanish Armada Defeated", "year": 1588},
        {"event": "Jamestown Founded", "year": 1607},
        {"event": "Pilgrims Land at Plymouth Rock", "year": 1620},
        {"event": "Galileo Publishes Findings", "year": 1632},
        {"event": "English Civil War Begins", "year": 1642},
        {"event": "Isaac Newton's Principia Published", "year": 1687},
        {"event": "War of 1812 Begins", "year": 1812},
        {"event": "Mexican Independence", "year": 1821},
        {"event": "Alamo Battle", "year": 1836},
        {"event": "California Gold Rush", "year": 1849},
        {"event": "Emancipation Proclamation", "year": 1863},
        {"event": "Alaska Purchased", "year": 1867},
        {"event": "Eiffel Tower Completed", "year": 1889},
        {"event": "Spanish-American War", "year": 1898},
        {"event": "Panama Canal Opens", "year": 1914},
        {"event": "Women's Suffrage Amendment", "year": 1920},
        {"event": "Lindbergh Crosses Atlantic", "year": 1927},
        {"event": "Social Security Act", "year": 1935},
        {"event": "NATO Founded", "year": 1949},
    ]
...
def generate_geography_dash(difficulty='medium'):
    ...
    questions = [
        ...
        {"question": "What is the capital of Brazil?", "answer": "Brasilia", "options": ["Brasilia", "Rio de Janeiro", "Sao Paulo", "Salvador"]},
        {"question": "Where is the Taj Mahal?", "answer": "India", "options": ["India", "Pakistan", "Bangladesh", "Nepal"]},
        {"question": "What is the capital of Russia?", "answer": "Moscow", "options": ["Moscow", "St. Petersburg", "Kiev", "Minsk"]},
        {"question": "Which river runs through Egypt?", "answer": "Nile", "options": ["Nile", "Niger", "Congo", "Zambezi"]},
        {"question": "What is the capital of Australia?", "answer": "Canberra", "options": ["Canberra", "Sydney", "Melbourne", "Brisbane"]},
        {"question": "Where is Machu Picchu?", "answer": "Peru", "options": ["Peru", "Bolivia", "Ecuador", "Chile"]},
        {"question": "What is the capital of Mexico?", "answer": "Mexico City", "options": ["Mexico City", "Guadalajara", "Cancun", "Tijuana"]},
        {"question": "Which mountain range is in South America?", "answer": "Andes", "options": ["Andes", "Rockies", "Himalayas", "Alps"]},
        {"question": "What is the capital of India?", "answer": "New Delhi", "options": ["New Delhi", "Mumbai", "Bangalore", "Kolkata"]},
        {"question": "Where is the Grand Canyon?", "answer": "Arizona", "options": ["Arizona", "Utah", "Nevada", "New Mexico"]},
        {"question": "What is the capital of Egypt?", "answer": "Cairo", "options": ["Cairo", "Alexandria", "Luxor", "Giza"]},
        {"question": "Which sea is the saltiest?", "answer": "Dead Sea", "options": ["Dead Sea", "Red Sea", "Black Sea", "Mediterranean"]},
        {"question": "What is the capital of Greece?", "answer": "Athens", "options": ["Athens", "Sparta", "Thessaloniki", "Crete"]},
        {"question": "Where is Victoria Falls?", "answer": "Zimbabwe/Zambia", "options": ["Zimbabwe/Zambia", "Kenya", "Tanzania", "Uganda"]},
        {"question": "What is the capital of Argentina?", "answer": "Buenos Aires", "options": ["Buenos Aires", "Cordoba", "Rosario", "Mendoza"]},
        {"question": "Which island country is south of India?", "answer": "Sri Lanka", "options": ["Sri Lanka", "Maldives", "Madagascar", "Mauritius"]},
        {"question": "What is the capital of Turkey?", "answer": "Ankara", "options": ["Ankara", "Istanbul", "Izmir", "Bursa"]},
        {"question": "Where is the Colosseum?", "answer": "Rome", "options": ["Rome", "Athens", "Istanbul", "Cairo"]},
        {"question": "What is the capital of South Korea?", "answer": "Seoul", "options": ["Seoul", "Busan", "Pyongyang", "Tokyo"]},
        {"question": "Which waterfall is largest by volume?", "answer": "Victoria Falls", "options": ["Victoria Falls", "Niagara Falls", "Angel Falls", "Iguazu Falls"]},
        {"question": "What is the capital of Thailand?", "answer": "Bangkok", "options": ["Bangkok", "Chiang Mai", "Phuket", "Hanoi"]},
        {"question": "Where is the Amazon rainforest mostly located?", "answer": "Brazil", "options": ["Brazil", "Peru", "Colombia", "Venezuela"]},
        {"question": "What is the capital of Sweden?", "answer": "Stockholm", "options": ["Stockholm", "Oslo", "Copenhagen", "Helsinki"]},
        {"question": "Which strait separates Europe and Africa?", "answer": "Gibraltar", "options": ["Gibraltar", "Bering", "Bosphorus", "Hormuz"]},
        {"question": "What is the capital of South Africa?", "answer": "Pretoria", "options": ["Pretoria", "Cape Town", "Johannesburg", "Durban"]},
        {"question": "Where is the Leaning Tower of Pisa?", "answer": "Italy", "options": ["Italy", "France", "Spain", "Greece"]},
        {"question": "What is the capital of Poland?", "answer": "Warsaw", "options": ["Warsaw", "Krakow", "Prague", "Budapest"]},
        {"question": "Which ocean is the warmest?", "answer": "Indian", "options": ["Indian", "Pacific", "Atlantic", "Arctic"]},
        {"question": "What is the capital of Vietnam?", "answer": "Hanoi", "options": ["Hanoi", "Ho Chi Minh City", "Da Nang", "Bangkok"]},
        {"question": "Where is Stonehenge?", "answer": "England", "options": ["England", "Scotland", "Ireland", "Wales"]},
        {"question": "What is the capital of Norway?", "answer": "Oslo", "options": ["Oslo", "Stockholm", "Copenhagen", "Helsinki"]},
        {"question": "Which continent has the most countries?", "answer": "Africa", "options": ["Africa", "Asia", "Europe", "South America"]},
        {"question": "What is the capital of Chile?", "answer": "Santiago", "options": ["Santiago", "Lima", "Buenos Aires", "Bogota"]},
        {"question": "Where is the Great Barrier Reef?", "answer": "Australia", "options": ["Australia", "Indonesia", "Philippines", "Fiji"]},
        {"question": "What is the capital of Portugal?", "answer": "Lisbon", "options": ["Lisbon", "Porto", "Madrid", "Barcelona"]},
        {"question": "Which river is longest in Europe?", "answer": "Volga", "options": ["Volga", "Danube", "Rhine", "Thames"]},
        {"question": "What is the capital of New Zealand?", "answer": "Wellington", "options": ["Wellington", "Auckland", "Christchurch", "Sydney"]},
        {"question": "Where is Big Ben?", "answer": "London", "options": ["London", "Paris", "Dublin", "Edinburgh"]},
        {"question": "What is the capital of Indonesia?", "answer": "Jakarta", "options": ["Jakarta", "Bali", "Singapore", "Kuala Lumpur"]},
        {"question": "Which sea borders Israel?", "answer": "Mediterranean", "options": ["Mediterranean", "Red Sea", "Dead Sea", "Black Sea"]},
        {"question": "What is the capital of Austria?", "answer": "Vienna", "options": ["Vienna", "Salzburg", "Munich", "Prague"]},
        {"question": "Where is Angel Falls?", "answer": "Venezuela", "options": ["Venezuela", "Brazil", "Colombia", "Peru"]},
    ]
...
BIBLE_QUESTIONS = {
    "easy": [
        ...
        {"question": "Who killed Abel?", "answer": "Cain", "options": ["Cain", "Seth", "Adam", "Lamech"]},
        {"question": "What was God's sign to Noah?", "answer": "Rainbow", "options": ["Rainbow", "Dove", "Olive branch", "Cloud"]},
        {"question": "How many sons did Jacob have?", "answer": "12", "options": ["12", "10", "7", "5"]},
        {"question": "What did God give Moses on the mountain?", "answer": "Ten Commandments", "options": ["Ten Commandments", "Staff", "Fire", "Water"]},
        {"question": "Who was thrown into a fiery furnace?", "answer": "Shadrach, Meshach, Abednego", "options": ["Shadrach, Meshach, Abednego", "Daniel", "Joseph", "Jeremiah"]},
        {"question": "What did David use to fight Goliath?", "answer": "Sling and stone", "options": ["Sling and stone", "Sword", "Spear", "Bow and arrow"]},
        {"question": "Who was the wisest king?", "answer": "Solomon", "options": ["Solomon", "David", "Saul", "Josiah"]},
        {"question": "What sea did Moses part?", "answer": "Red Sea", "options": ["Red Sea", "Dead Sea", "Mediterranean Sea", "Sea of Galilee"]},
        {"question": "Who was Jesus' earthly father?", "answer": "Joseph", "options": ["Joseph", "Jacob", "Zechariah", "Simeon"]},
        {"question": "How many animals of each kind on the ark?", "answer": "2", "options": ["2", "7", "10", "1"]},
        {"question": "What food fell from heaven?", "answer": "Manna", "options": ["Manna", "Quail", "Bread", "Honey"]},
        {"question": "Who was the brother of Jesus?", "answer": "James", "options": ["James", "John", "Peter", "Andrew"]},
        {"question": "What city walls fell down?", "answer": "Jericho", "options": ["Jericho", "Jerusalem", "Babylon", "Nineveh"]},
        {"question": "Who was a fisherman before following Jesus?", "answer": "Peter", "options": ["Peter", "Matthew", "Paul", "Luke"]},
        {"question": "What did God create on day 2?", "answer": "Sky", "options": ["Sky", "Water", "Land", "Stars"]},
        {"question": "Who was sold by his brothers?", "answer": "Joseph", "options": ["Joseph", "Benjamin", "Jacob", "Reuben"]},
        {"question": "What sign did the wise men follow?", "answer": "Star", "options": ["Star", "Cloud", "Angel", "Fire"]},
        {"question": "Who was the tax collector disciple?", "answer": "Matthew", "options": ["Matthew", "Luke", "Peter", "John"]},
        {"question": "What did Zacchaeus climb?", "answer": "Sycamore tree", "options": ["Sycamore tree", "Palm tree", "Olive tree", "Fig tree"]},
        {"question": "How many commandments did God give?", "answer": "10", "options": ["10", "12", "7", "5"]},
        {"question": "Who was the giant Goliath from?", "answer": "Philistines", "options": ["Philistines", "Egyptians", "Assyrians", "Babylonians"]},
        {"question": "What river was Jesus baptized in?", "answer": "Jordan", "options": ["Jordan", "Nile", "Euphrates", "Tigris"]},
        {"question": "Who climbed a tree to see Jesus?", "answer": "Zacchaeus", "options": ["Zacchaeus", "Nicodemus", "Joseph", "Barnabas"]},
        {"question": "What did God create on day 3?", "answer": "Land and plants", "options": ["Land and plants", "Animals", "Humans", "Stars"]},
        {"question": "Who was Ruth's mother-in-law?", "answer": "Naomi", "options": ["Naomi", "Rachel", "Leah", "Sarah"]},
        {"question": "What was Moses' sister's name?", "answer": "Miriam", "options": ["Miriam", "Sarah", "Deborah", "Esther"]},
        {"question": "Who was swallowed by a whale?", "answer": "Jonah", "options": ["Jonah", "Job", "Joel", "Joshua"]},
        {"question": "What did God create on day 4?", "answer": "Sun, moon, stars", "options": ["Sun, moon, stars", "Animals", "Birds", "Humans"]},
        {"question": "Who was Abraham's wife?", "answer": "Sarah", "options": ["Sarah", "Rachel", "Leah", "Rebecca"]},
        {"question": "What did Jesus feed 5000 people with?", "answer": "5 loaves and 2 fish", "options": ["5 loaves and 2 fish", "7 loaves", "Manna", "Wine and bread"]},
        {"question": "Who was the oldest man?", "answer": "Methuselah", "options": ["Methuselah", "Noah", "Adam", "Abraham"]},
        {"question": "What did God create on day 5?", "answer": "Fish and birds", "options": ["Fish and birds", "Land animals", "Humans", "Plants"]},
        {"question": "Who wrote most of the Psalms?", "answer": "David", "options": ["David", "Solomon", "Moses", "Samuel"]},
        {"question": "What did God create on day 6?", "answer": "Animals and humans", "options": ["Animals and humans", "Fish", "Birds", "Plants"]},
        {"question": "Who was thrown to the lions?", "answer": "Daniel", "options": ["Daniel", "David", "Jonah", "Joseph"]},
        {"question": "What day did God rest?", "answer": "7th day", "options": ["7th day", "6th day", "1st day", "8th day"]},
        {"question": "Who built the temple in Jerusalem?", "answer": "Solomon", "options": ["Solomon", "David", "Moses", "Joshua"]},
        {"question": "What garden did God place Adam and Eve in?", "answer": "Eden", "options": ["Eden", "Gethsemane", "Olive", "Paradise"]},
        {"question": "Who was the first king of Israel?", "answer": "Saul", "options": ["Saul", "David", "Solomon", "Samuel"]},
        {"question": "What fruit did Adam and Eve eat?", "answer": "Forbidden fruit", "options": ["Forbidden fruit", "Apple", "Fig", "Grape"]},
    ],
    "medium": [
        ...
        {"question": "How many books are in the Old Testament?", "answer": "39", "options": ["39", "27", "66", "40"]},
        {"question": "Who was Isaac's wife?", "answer": "Rebekah", "options": ["Rebekah", "Rachel", "Leah", "Sarah"]},
        {"question": "What did Samson use to kill 1000 men?", "answer": "Jawbone of a donkey", "options": ["Jawbone of a donkey", "Sword", "Spear", "Rock"]},
        {"question": "Who was the mother of John the Baptist?", "answer": "Elizabeth", "options": ["Elizabeth", "Mary", "Anna", "Salome"]},
        {"question": "What tribe was Jesus from?", "answer": "Judah", "options": ["Judah", "Levi", "Benjamin", "Ephraim"]},
        {"question": "Who was the judge who led Israel with Deborah?", "answer": "Barak", "options": ["Barak", "Gideon", "Samson", "Jephthah"]},
        {"question": "What did Esau sell for a bowl of stew?", "answer": "His birthright", "options": ["His birthright", "His land", "His sheep", "His sword"]},
        {"question": "Who was the cupbearer to the king?", "answer": "Nehemiah", "options": ["Nehemiah", "Ezra", "Daniel", "Mordecai"]},
        {"question": "What prophet was carried to heaven in a chariot?", "answer": "Elijah", "options": ["Elijah", "Elisha", "Isaiah", "Ezekiel"]},
        {"question": "Who was the mother of Samuel?", "answer": "Hannah", "options": ["Hannah", "Peninnah", "Ruth", "Naomi"]},
        {"question": "What sign did God give Gideon?", "answer": "Fleece with dew", "options": ["Fleece with dew", "Fire from heaven", "Rainbow", "Earthquake"]},
        {"question": "Who was the prophet that anointed David?", "answer": "Samuel", "options": ["Samuel", "Nathan", "Gad", "Elijah"]},
        {"question": "What did the Israelites carry in the wilderness?", "answer": "Ark of the Covenant", "options": ["Ark of the Covenant", "Golden calf", "Tabernacle", "Altar"]},
        {"question": "Who was Ruth's husband?", "answer": "Boaz", "options": ["Boaz", "Obed", "Jesse", "Elimelech"]},
        {"question": "What judge made a foolish vow?", "answer": "Jephthah", "options": ["Jephthah", "Gideon", "Samson", "Barak"]},
        {"question": "Who was the father of the 12 tribes?", "answer": "Jacob", "options": ["Jacob", "Isaac", "Abraham", "Joseph"]},
        {"question": "What did God provide for Abraham to sacrifice?", "answer": "Ram", "options": ["Ram", "Lamb", "Goat", "Dove"]},
        {"question": "Who was the prophet swallowed by a fish?", "answer": "Jonah", "options": ["Jonah", "Joel", "Micah", "Nahum"]},
        {"question": "What city did Joshua conquer first?", "answer": "Jericho", "options": ["Jericho", "Ai", "Jerusalem", "Hebron"]},
        {"question": "Who was the disciple who doubted?", "answer": "Thomas", "options": ["Thomas", "Peter", "Philip", "Nathanael"]},
        {"question": "What mountain did Moses receive the law?", "answer": "Sinai", "options": ["Sinai", "Horeb", "Nebo", "Carmel"]},
        {"question": "Who was the first Christian martyr?", "answer": "Stephen", "options": ["Stephen", "James", "Paul", "Peter"]},
        {"question": "What did the prodigal son waste?", "answer": "His inheritance", "options": ["His inheritance", "His land", "His sheep", "His time"]},
        {"question": "Who was the Roman centurion with great faith?", "answer": "Cornelius", "options": ["Cornelius", "Julius", "Claudius", "Marcus"]},
        {"question": "What was Esther's Hebrew name?", "answer": "Hadassah", "options": ["Hadassah", "Hannah", "Deborah", "Miriam"]},
        {"question": "Who was the wisest man before Solomon?", "answer": "Ethan the Ezrahite", "options": ["Ethan the Ezrahite", "David", "Joseph", "Daniel"]},
        {"question": "What prophet confronted King Ahab?", "answer": "Elijah", "options": ["Elijah", "Elisha", "Isaiah", "Jeremiah"]},
        {"question": "Who was the mother of Moses?", "answer": "Jochebed", "options": ["Jochebed", "Miriam", "Zipporah", "Deborah"]},
        {"question": "What did the widow give in the temple?", "answer": "Two mites", "options": ["Two mites", "One denarius", "Half a shekel", "Silver coins"]},
        {"question": "Who was the prophetess who spoke of baby Jesus?", "answer": "Anna", "options": ["Anna", "Elizabeth", "Mary", "Deborah"]},
        {"question": "What was Barnabas' real name?", "answer": "Joseph", "options": ["Joseph", "Judas", "John", "James"]},
        {"question": "Who was healed by looking at a bronze serpent?", "answer": "Israelites", "options": ["Israelites", "Egyptians", "Philistines", "Canaanites"]},
        {"question": "What king had leprosy?", "answer": "Uzziah", "options": ["Uzziah", "Hezekiah", "Josiah", "Jehoram"]},
        {"question": "Who was Paul's traveling companion?", "answer": "Silas", "options": ["Silas", "Timothy", "Titus", "Luke"]},
        {"question": "What prophet saw dry bones come to life?", "answer": "Ezekiel", "options": ["Ezekiel", "Jeremiah", "Isaiah", "Daniel"]},
        {"question": "Who was the king of Babylon?", "answer": "Nebuchadnezzar", "options": ["Nebuchadnezzar", "Cyrus", "Darius", "Belshazzar"]},
        {"question": "What did Jacob wrestle with?", "answer": "Angel", "options": ["Angel", "Man", "Lion", "Bear"]},
        {"question": "Who was the prophet that ate a scroll?", "answer": "Ezekiel", "options": ["Ezekiel", "Jeremiah", "Isaiah", "Daniel"]},
        {"question": "What was David's sin?", "answer": "Adultery and murder", "options": ["Adultery and murder", "Idolatry", "Pride", "Greed"]},
        {"question": "Who was the Persian king who helped rebuild?", "answer": "Cyrus", "options": ["Cyrus", "Darius", "Artaxerxes", "Xerxes"]},
    ],
    "hard": [
        ...
        {"question": "What was the original language of the New Testament?", "answer": "Greek", "options": ["Greek", "Hebrew", "Aramaic", "Latin"]},
        {"question": "How many epistles did John write?", "answer": "3", "options": ["3", "5", "2", "4"]},
        {"question": "What is the shortest book in the Old Testament?", "answer": "Obadiah", "options": ["Obadiah", "Jonah", "Haggai", "Nahum"]},
        {"question": "Who was the priest of Midian and Moses' father-in-law?", "answer": "Jethro", "options": ["Jethro", "Reuel", "Hobab", "Zipporah"]},
        {"question": "What does 'Messiah' mean in Hebrew?", "answer": "Anointed One", "options": ["Anointed One", "Savior", "King", "Prophet"]},
        {"question": "Who was the scribe who led reforms with Nehemiah?", "answer": "Ezra", "options": ["Ezra", "Nehemiah", "Zerubbabel", "Haggai"]},
        {"question": "What city is called the City of David?", "answer": "Bethlehem", "options": ["Bethlehem", "Jerusalem", "Hebron", "Nazareth"]},
        {"question": "Who was the prophetess and judge of Israel?", "answer": "Deborah", "options": ["Deborah", "Miriam", "Huldah", "Anna"]},
        {"question": "What does 'Maranatha' mean?", "answer": "Come, O Lord", "options": ["Come, O Lord", "Praise God", "Hallelujah", "Amen"]},
        {"question": "Who was the king who had a dream of a statue?", "answer": "Nebuchadnezzar", "options": ["Nebuchadnezzar", "Cyrus", "Darius", "Belshazzar"]},
        {"question": "What is the shortest book in the New Testament?", "answer": "2 John", "options": ["2 John", "3 John", "Philemon", "Jude"]},
        {"question": "Who was the firstborn son of Adam and Eve?", "answer": "Cain", "options": ["Cain", "Abel", "Seth", "Enosh"]},
        {"question": "What does 'Christ' mean in Greek?", "answer": "Anointed One", "options": ["Anointed One", "Savior", "King", "Lord"]},
        {"question": "Who was the judge who made a vow about his daughter?", "answer": "Jephthah", "options": ["Jephthah", "Gideon", "Samson", "Barak"]},
        {"question": "What is the middle verse of the Bible?", "answer": "Psalm 118:8", "options": ["Psalm 118:8", "Proverbs 15:17", "John 11:35", "Isaiah 40:31"]},
        {"question": "Who was the high priest when Eli died?", "answer": "Phinehas", "options": ["Phinehas", "Hophni", "Samuel", "Abiathar"]},
        {"question": "What does 'Selah' mean in Psalms?", "answer": "Pause or reflect", "options": ["Pause or reflect", "Amen", "Forever", "Praise"]},
        {"question": "Who was the king of Tyre who helped Solomon?", "answer": "Hiram", "options": ["Hiram", "Ahab", "Ben-Hadad", "Rezin"]},
        {"question": "What does 'Hosanna' mean?", "answer": "Save now", "options": ["Save now", "Praise God", "Hallelujah", "Holy"]},
        {"question": "Who was the cupbearer who became governor?", "answer": "Nehemiah", "options": ["Nehemiah", "Ezra", "Daniel", "Mordecai"]},
        {"question": "What valley did David fight Goliath in?", "answer": "Valley of Elah", "options": ["Valley of Elah", "Kidron Valley", "Valley of Achor", "Jezreel Valley"]},
        {"question": "Who was the prophet who married a prostitute?", "answer": "Hosea", "options": ["Hosea", "Jeremiah", "Ezekiel", "Isaiah"]},
        {"question": "What does 'Emmanuel' mean?", "answer": "God with us", "options": ["God with us", "Mighty God", "Prince of Peace", "Wonderful Counselor"]},
        {"question": "Who was the son of Saul who befriended David?", "answer": "Jonathan", "options": ["Jonathan", "Ishbosheth", "Mephibosheth", "Abner"]},
        {"question": "What Persian feast is in the book of Esther?", "answer": "Purim", "options": ["Purim", "Passover", "Pentecost", "Tabernacles"]},
        {"question": "Who was the prophet who confronted David?", "answer": "Nathan", "options": ["Nathan", "Gad", "Samuel", "Elijah"]},
        {"question": "What does 'Abba' mean?", "answer": "Father", "options": ["Father", "God", "Lord", "King"]},
        {"question": "Who was the last judge of Israel?", "answer": "Samuel", "options": ["Samuel", "Eli", "Samson", "Jephthah"]},
        {"question": "What is the Golden Rule found in?", "answer": "Matthew 7:12", "options": ["Matthew 7:12", "Luke 6:31", "John 13:34", "Romans 12:10"]},
        {"question": "Who was the priest who blessed baby Jesus?", "answer": "Simeon", "options": ["Simeon", "Zechariah", "Annas", "Caiaphas"]},
        {"question": "What mountain did Abraham offer Isaac?", "answer": "Moriah", "options": ["Moriah", "Sinai", "Horeb", "Carmel"]},
        {"question": "Who was the prophet to Nineveh?", "answer": "Jonah", "options": ["Jonah", "Nahum", "Micah", "Habakkuk"]},
        {"question": "What does 'Hallelujah' mean?", "answer": "Praise the Lord", "options": ["Praise the Lord", "God is good", "Holy", "Amen"]},
        {"question": "Who was the king who repented in sackcloth?", "answer": "Ahab", "options": ["Ahab", "Manasseh", "Josiah", "Hezekiah"]},
        {"question": "What is the central book of the Bible?", "answer": "Psalms", "options": ["Psalms", "Proverbs", "Isaiah", "Micah"]},
        {"question": "Who was the prophet who saw a wheel within a wheel?", "answer": "Ezekiel", "options": ["Ezekiel", "Daniel", "Isaiah", "Jeremiah"]},
        {"question": "What does 'Sabbath' mean?", "answer": "Rest", "options": ["Rest", "Holy", "Seventh", "Day"]},
        {"question": "Who was the apostle to the Gentiles?", "answer": "Paul", "options": ["Paul", "Peter", "James", "John"]},
        {"question": "What mountain did Elijah confront Baal's prophets?", "answer": "Carmel", "options": ["Carmel", "Sinai", "Horeb", "Nebo"]},
        {"question": "Who was the Roman procurator after Pilate?", "answer": "Felix", "options": ["Felix", "Festus", "Agrippa", "Herod"]},
    ]
}
...
def generate_country_spotter(difficulty='medium'):
    ...
    countries_by_difficulty = {
        'easy': [
            ...
            {"country": "France", "shape_hint": "Hexagon-shaped in Western Europe", "answer": "France", "options": ["France", "Germany", "Poland", "Belgium"]},
            {"country": "India", "shape_hint": "Diamond-shaped subcontinent", "answer": "India", "options": ["India", "Pakistan", "Bangladesh", "Sri Lanka"]},
            {"country": "Egypt", "shape_hint": "Northeast Africa along Nile River", "answer": "Egypt", "options": ["Egypt", "Libya", "Sudan", "Tunisia"]},
            {"country": "Mexico", "shape_hint": "Between United States and Central America", "answer": "Mexico", "options": ["Mexico", "Guatemala", "Honduras", "Nicaragua"]},
            {"country": "China", "shape_hint": "Largest country in East Asia", "answer": "China", "options": ["China", "Mongolia", "Kazakhstan", "India"]},
            {"country": "Brazil", "shape_hint": "Largest country in South America", "answer": "Brazil", "options": ["Brazil", "Argentina", "Colombia", "Peru"]},
            {"country": "Russia", "shape_hint": "Largest country in the world", "answer": "Russia", "options": ["Russia", "Canada", "United States", "China"]},
            {"country": "Canada", "shape_hint": "North of United States with many lakes", "answer": "Canada", "options": ["Canada", "United States", "Greenland", "Alaska"]},
            {"country": "Spain", "shape_hint": "Iberian Peninsula in Southwest Europe", "answer": "Spain", "options": ["Spain", "Portugal", "France", "Italy"]},
            {"country": "Germany", "shape_hint": "Heart of Central Europe", "answer": "Germany", "options": ["Germany", "Poland", "France", "Austria"]},
            {"country": "Turkey", "shape_hint": "Bridges Europe and Asia", "answer": "Turkey", "options": ["Turkey", "Greece", "Iran", "Syria"]},
            {"country": "South Africa", "shape_hint": "Southern tip of Africa", "answer": "South Africa", "options": ["South Africa", "Namibia", "Botswana", "Zimbabwe"]},
            {"country": "Argentina", "shape_hint": "Stretches along South America's east coast", "answer": "Argentina", "options": ["Argentina", "Chile", "Uruguay", "Brazil"]},
            {"country": "Indonesia", "shape_hint": "Thousands of islands in Southeast Asia", "answer": "Indonesia", "options": ["Indonesia", "Philippines", "Malaysia", "Papua New Guinea"]},
            {"country": "Saudi Arabia", "shape_hint": "Large peninsula in Middle East", "answer": "Saudi Arabia", "options": ["Saudi Arabia", "Yemen", "Oman", "Iraq"]},
        ],
        'medium': [
            ...
            {"country": "Portugal", "shape_hint": "Western edge of Iberian Peninsula", "answer": "Portugal", "options": ["Portugal", "Spain", "Morocco", "France"]},
            {"country": "Greece", "shape_hint": "Many peninsulas and islands in Mediterranean", "answer": "Greece", "options": ["Greece", "Italy", "Turkey", "Albania"]},
            {"country": "Vietnam", "shape_hint": "S-shaped along South China Sea", "answer": "Vietnam", "options": ["Vietnam", "Laos", "Cambodia", "Thailand"]},
            {"country": "Poland", "shape_hint": "Between Germany and Russia", "answer": "Poland", "options": ["Poland", "Czech Republic", "Ukraine", "Belarus"]},
            {"country": "Sweden", "shape_hint": "Long Scandinavian country", "answer": "Sweden", "options": ["Sweden", "Norway", "Finland", "Denmark"]},
            {"country": "Philippines", "shape_hint": "Island archipelago in Pacific", "answer": "Philippines", "options": ["Philippines", "Indonesia", "Malaysia", "Vietnam"]},
            {"country": "Ireland", "shape_hint": "Island west of Great Britain", "answer": "Ireland", "options": ["Ireland", "United Kingdom", "Iceland", "Scotland"]},
            {"country": "New Zealand", "shape_hint": "Two main islands in Pacific", "answer": "New Zealand", "options": ["New Zealand", "Australia", "Fiji", "Tasmania"]},
            {"country": "Cuba", "shape_hint": "Largest Caribbean island", "answer": "Cuba", "options": ["Cuba", "Jamaica", "Haiti", "Puerto Rico"]},
            {"country": "Peru", "shape_hint": "Western South America with Andes", "answer": "Peru", "options": ["Peru", "Ecuador", "Bolivia", "Colombia"]},
            {"country": "Venezuela", "shape_hint": "Northern South America with Caribbean coast", "answer": "Venezuela", "options": ["Venezuela", "Colombia", "Guyana", "Brazil"]},
            {"country": "Kenya", "shape_hint": "East African country on equator", "answer": "Kenya", "options": ["Kenya", "Tanzania", "Uganda", "Ethiopia"]},
            {"country": "Romania", "shape_hint": "Carpathian Mountains in Eastern Europe", "answer": "Romania", "options": ["Romania", "Bulgaria", "Hungary", "Moldova"]},
            {"country": "Netherlands", "shape_hint": "Low-lying coastal country", "answer": "Netherlands", "options": ["Netherlands", "Belgium", "Denmark", "Luxembourg"]},
            {"country": "Austria", "shape_hint": "Landlocked Alpine country", "answer": "Austria", "options": ["Austria", "Switzerland", "Germany", "Czech Republic"]},
        ],
        'hard': [
            ...
            {"country": "Kyrgyzstan", "shape_hint": "Mountainous Central Asian country", "answer": "Kyrgyzstan", "options": ["Kyrgyzstan", "Tajikistan", "Uzbekistan", "Kazakhstan"]},
            {"country": "Eritrea", "shape_hint": "Red Sea coastline in Horn of Africa", "answer": "Eritrea", "options": ["Eritrea", "Djibouti", "Somalia", "Ethiopia"]},
            {"country": "Montenegro", "shape_hint": "Small Adriatic country in Balkans", "answer": "Montenegro", "options": ["Montenegro", "Albania", "Macedonia", "Kosovo"]},
            {"country": "Laos", "shape_hint": "Landlocked Southeast Asian country", "answer": "Laos", "options": ["Laos", "Cambodia", "Myanmar", "Thailand"]},
            {"country": "Luxembourg", "shape_hint": "Tiny landlocked Western European country", "answer": "Luxembourg", "options": ["Luxembourg", "Belgium", "Liechtenstein", "Monaco"]},
            {"country": "Uruguay", "shape_hint": "Small country between Argentina and Brazil", "answer": "Uruguay", "options": ["Uruguay", "Paraguay", "Suriname", "Guyana"]},
            {"country": "Slovenia", "shape_hint": "Alpine country between Italy and Croatia", "answer": "Slovenia", "options": ["Slovenia", "Slovakia", "Croatia", "Austria"]},
            {"country": "Armenia", "shape_hint": "Landlocked Caucasus country", "answer": "Armenia", "options": ["Armenia", "Azerbaijan", "Georgia", "Turkey"]},
            {"country": "Albania", "shape_hint": "Adriatic coast in western Balkans", "answer": "Albania", "options": ["Albania", "Macedonia", "Kosovo", "Montenegro"]},
            {"country": "Namibia", "shape_hint": "Southwest African coastal country", "answer": "Namibia", "options": ["Namibia", "Botswana", "Angola", "Zambia"]},
            {"country": "Lithuania", "shape_hint": "Baltic country south of Latvia", "answer": "Lithuania", "options": ["Lithuania", "Latvia", "Estonia", "Belarus"]},
            {"country": "Serbia", "shape_hint": "Central Balkan country, formerly part of Yugoslavia", "answer": "Serbia", "options": ["Serbia", "Croatia", "Bosnia", "Montenegro"]},
            {"country": "Tunisia", "shape_hint": "North African Mediterranean country", "answer": "Tunisia", "options": ["Tunisia", "Algeria", "Libya", "Morocco"]},
            {"country": "Tajikistan", "shape_hint": "Mountainous country in Central Asia", "answer": "Tajikistan", "options": ["Tajikistan", "Kyrgyzstan", "Uzbekistan", "Afghanistan"]},
            {"country": "Georgia", "shape_hint": "Caucasus country between Russia and Turkey", "answer": "Georgia", "options": ["Georgia", "Armenia", "Azerbaijan", "Uzbekistan"]},
        ]
    }
...
def generate_capital_quest(difficulty='medium'):
    ...
    capitals_by_difficulty = {
        'easy': [
            ...
            {"question": "What is the capital of Spain?", "answer": "Madrid", "options": ["Madrid", "Barcelona", "Seville", "Valencia"]},
            {"question": "What is the capital of Russia?", "answer": "Moscow", "options": ["Moscow", "Saint Petersburg", "Novosibirsk", "Kazan"]},
            {"question": "What is the capital of Argentina?", "answer": "Buenos Aires", "options": ["Buenos Aires", "Córdoba", "Rosario", "Mendoza"]},
            {"question": "What is the capital of South Korea?", "answer": "Seoul", "options": ["Seoul", "Busan", "Incheon", "Daegu"]},
            {"question": "What is the capital of Turkey?", "answer": "Ankara", "options": ["Ankara", "Istanbul", "Izmir", "Bursa"]},
            {"question": "What is the capital of Greece?", "answer": "Athens", "options": ["Athens", "Thessaloniki", "Patras", "Crete"]},
            {"question": "What is the capital of Thailand?", "answer": "Bangkok", "options": ["Bangkok", "Chiang Mai", "Phuket", "Pattaya"]},
            {"question": "What is the capital of United States?", "answer": "Washington DC", "options": ["Washington DC", "New York", "Los Angeles", "Chicago"]},
        ],
        'medium': [
            ...
            {"question": "What is the capital of Austria?", "answer": "Vienna", "options": ["Vienna", "Salzburg", "Graz", "Innsbruck"]},
            {"question": "What is the capital of Norway?", "answer": "Oslo", "options": ["Oslo", "Bergen", "Trondheim", "Stavanger"]},
            {"question": "What is the capital of Poland?", "answer": "Warsaw", "options": ["Warsaw", "Krakow", "Gdansk", "Wroclaw"]},
            {"question": "What is the capital of Chile?", "answer": "Santiago", "options": ["Santiago", "Valparaiso", "Concepcion", "Viña del Mar"]},
            {"question": "What is the capital of Indonesia?", "answer": "Jakarta", "options": ["Jakarta", "Bali", "Surabaya", "Bandung"]},
            {"question": "What is the capital of Ireland?", "answer": "Dublin", "options": ["Dublin", "Cork", "Galway", "Limerick"]},
            {"question": "What is the capital of Malaysia?", "answer": "Kuala Lumpur", "options": ["Kuala Lumpur", "Penang", "Johor Bahru", "Ipoh"]},
            {"question": "What is the capital of Colombia?", "answer": "Bogotá", "options": ["Bogotá", "Medellín", "Cali", "Cartagena"]},
            {"question": "What is the capital of Philippines?", "answer": "Manila", "options": ["Manila", "Quezon City", "Davao", "Cebu"]},
            {"question": "What is the capital of Czech Republic?", "answer": "Prague", "options": ["Prague", "Brno", "Ostrava", "Pilsen"]},
            {"question": "What is the capital of Hungary?", "answer": "Budapest", "options": ["Budapest", "Debrecen", "Szeged", "Miskolc"]},
        ],
        'hard': [
            ...
            {"question": "What is the capital of Sri Lanka?", "answer": "Sri Jayawardenepura Kotte", "options": ["Sri Jayawardenepura Kotte", "Colombo", "Kandy", "Galle"]},
            {"question": "What is the capital of Belarus?", "answer": "Minsk", "options": ["Minsk", "Gomel", "Vitebsk", "Mogilev"]},
            {"question": "What is the capital of Azerbaijan?", "answer": "Baku", "options": ["Baku", "Ganja", "Sumqayit", "Lankaran"]},
            {"question": "What is the capital of Mongolia?", "answer": "Ulaanbaatar", "options": ["Ulaanbaatar", "Erdenet", "Darkhan", "Choibalsan"]},
            {"question": "What is the capital of Libya?", "answer": "Tripoli", "options": ["Tripoli", "Benghazi", "Misrata", "Sabha"]},
            {"question": "What is the capital of Slovenia?", "answer": "Ljubljana", "options": ["Ljubljana", "Maribor", "Kranj", "Celje"]},
            {"question": "What is the capital of Namibia?", "answer": "Windhoek", "options": ["Windhoek", "Walvis Bay", "Swakopmund", "Oshakati"]},
            {"question": "What is the capital of Nepal?", "answer": "Kathmandu", "options": ["Kathmandu", "Pokhara", "Lalitpur", "Biratnagar"]},
            {"question": "What is the capital of Lebanon?", "answer": "Beirut", "options": ["Beirut", "Tripoli", "Sidon", "Tyre"]},
            {"question": "What is the capital of Lithuania?", "answer": "Vilnius", "options": ["Vilnius", "Kaunas", "Klaipėda", "Šiauliai"]},
            ...
            {"question": "What is the capital of Moldova?", "answer": "Chișinău", "options": ["Chișinău", "Tiraspol", "Bălți", "Bender"]},
            {"question": "What is the capital of Kyrgyzstan?", "answer": "Bishkek", "options": ["Bishkek", "Osh", "Jalal-Abad", "Karakol"]},
        ]
    }
