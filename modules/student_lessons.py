...
# Import chapter structures from separate config file
from modules.chapters_config import (
    LESSON_CHAPTERS,
    get_chapters_for_subject_grade,
    get_chapter_by_id
)

# All chapter structures are now defined in chapters_config.py
# This keeps student_lessons.py clean and maintainable
